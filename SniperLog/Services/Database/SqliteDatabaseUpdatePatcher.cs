...
using SniperLog.Services.Configuration;
...
namespace SniperLog.Services.Database
{
    public static class SqliteDatabaseUpdatePatcher
    {
        ...
        private static AppConfig Config => ApplicationConfigService.GetConfig<AppConfig>();

        public static List<Version> AppliedPatchesVersions => Config.AppliedPatches;
        ...
        public static void CheckForUpdates()
        {
            ...
            if (anyApplied) ApplicationConfigService.SaveConfig(Config);
        }
    }
}