...
namespace SniperLog.Services.Database
{
    public static class DataAccessObjectQueryBuilder
    {
        ...
        public static string GetInsertQuery(Type type, bool includeReturning = true, bool insertOrUpdate = false)
        {
            ...
            if (insertOrUpdate) _cachedInsertNoIdQueries.Add(type, query);
        ...
        public static string GetDeleteQuery(Type type)
        {
            ...
            PropertyInfo? primaryKeyProperty = type.GetProperties().Where(n => n.MemberType is MemberTypes.Property && Attribute.IsDefined(n, typeof(PrimaryKey))).FirstOrDefault();
